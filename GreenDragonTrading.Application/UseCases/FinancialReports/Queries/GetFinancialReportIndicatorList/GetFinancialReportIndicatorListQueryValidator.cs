...
{
    public class GetFinancialReportIndicatorListQueryValidator : AbstractValidator<GetFinancialReportIndicatorListQuery>
    {
        public GetFinancialReportIndicatorListQueryValidator()
        {
