...
namespace GreenDragonTrading.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260407161408_AddListedShareAndIndicatorData")]
    partial class AddListedShareAndIndicatorData
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GreenDragonTrading.Domain.Entities.AnalysisReportCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Code = "1000",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 4, 7, 16, 14, 7, 300, DateTimeKind.Unspecified).AddTicks(655), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        {
                            Code = "2000",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 4, 7, 16, 14, 7, 300, DateTimeKind.Unspecified).AddTicks(675), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        {
                            Code = "3000",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 4, 7, 16, 14, 7, 300, DateTimeKind.Unspecified).AddTicks(678), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        {
                            Code = "4000",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 4, 7, 16, 14, 7, 300, DateTimeKind.Unspecified).AddTicks(680), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        {
                            Code = "5000",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 4, 7, 16, 14, 7, 300, DateTimeKind.Unspecified).AddTicks(682), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("GreenDragonTrading.Domain.Entities.ModuleLayout", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 4, 7, 16, 14, 7, 300, DateTimeKind.Unspecified).AddTicks(450), new TimeSpan(0, 0, 0, 0, 0)),
                            IsSystemDefault = true,
                            LayoutName = "Giao diện bộ lọc mặc định",
                            ModuleType = (short)1,
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 4, 7, 16, 14, 7, 300, DateTimeKind.Unspecified).AddTicks(450), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
            ...
            modelBuilder.Entity("GreenDragonTrading.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            HashedPassword = "$2a$11$pj2qN75TtRlqnLZARg82TOkzbWA8lcoJRjxPO4Q7dt4VEJSdcK8KK",
