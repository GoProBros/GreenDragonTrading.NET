...
namespace GreenDragonTrading.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20251227073327_AddFinancialReportEntity")]
    partial class AddFinancialReportEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GreenDragonTrading.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("351469d9-ea39-4327-ae96-3cb462969371"),
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 12, 27, 7, 33, 26, 490, DateTimeKind.Unspecified).AddTicks(4994), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("GreenDragonTrading.Domain.Entities.Workspace", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTimeOffset(new DateTime(2025, 12, 27, 7, 33, 26, 490, DateTimeKind.Unspecified).AddTicks(5076), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDefault = true,
                            LayoutJson = "{\r\n          \"modules\": [\r\n            { \"id\": \"watchList\", \"position\": { \"x\": 0, \"y\": 0, \"w\": 6, \"h\": 4 } },\r\n            { \"id\": \"chart\", \"position\": { \"x\": 6, \"y\": 0, \"w\": 6, \"h\": 8 } },\r\n            { \"id\": \"orderBook\", \"position\": { \"x\": 0, \"y\": 4, \"w\": 6, \"h\": 4 } }\r\n          ]\r\n        }",
                            UpdateAt = new DateTimeOffset(new DateTime(2025, 12, 27, 7, 33, 26, 490, DateTimeKind.Unspecified).AddTicks(5077), new TimeSpan(0, 0, 0, 0, 0)),
