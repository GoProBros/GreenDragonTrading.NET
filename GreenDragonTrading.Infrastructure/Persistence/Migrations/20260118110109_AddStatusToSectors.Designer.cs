...
namespace GreenDragonTrading.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260118110109_AddStatusToSectors")]
    partial class AddStatusToSectors
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GreenDragonTrading.Domain.Entities.ModuleLayout", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 1, 18, 11, 1, 7, 840, DateTimeKind.Unspecified).AddTicks(9036), new TimeSpan(0, 0, 0, 0, 0)),
                            IsSystemDefault = true,
                            LayoutName = "Giao diện bộ lọc mặc định",
                            ModuleType = (short)1,
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 1, 18, 11, 1, 7, 840, DateTimeKind.Unspecified).AddTicks(9037), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
            ...
            modelBuilder.Entity("GreenDragonTrading.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            HashedPassword = "$2a$11$dUjRftw200w1ubNjeblkguYpHVZShtJms/jHUltSeoYJ7cR0cyNNe",
            ...
            modelBuilder.Entity("GreenDragonTrading.Domain.Entities.Workspace", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 1, 18, 11, 1, 7, 840, DateTimeKind.Unspecified).AddTicks(9166), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDefault = true,
                            LayoutJson = "{\r\n          \"modules\": [\r\n            {\r\n              \"i\": \"stock-screener-default\",\r\n              \"type\": \"stock-screener\",\r\n              \"title\": \"Bộ lọc cổ phiếu\",\r\n              \"x\": 0, \"y\": 36, \"w\": 96, \"h\": 20,\r\n              \"activeLayoutId\": 1  \r\n            }\r\n          ]\r\n        }",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 1, 18, 11, 1, 7, 840, DateTimeKind.Unspecified).AddTicks(9167), new TimeSpan(0, 0, 0, 0, 0)),
