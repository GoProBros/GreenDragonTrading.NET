...
namespace GreenDragonTrading.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260506035551_AddProactiveAlertThrottleCooldown")]
    partial class AddProactiveAlertThrottleCooldown
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GreenDragonTrading.Domain.Entities.AnalysisReportCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Code = "1000",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 5, 6, 3, 55, 48, 695, DateTimeKind.Unspecified).AddTicks(2245), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        {
                            Code = "2000",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 5, 6, 3, 55, 48, 695, DateTimeKind.Unspecified).AddTicks(2252), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        {
                            Code = "3000",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 5, 6, 3, 55, 48, 695, DateTimeKind.Unspecified).AddTicks(2353), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        {
                            Code = "4000",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 5, 6, 3, 55, 48, 695, DateTimeKind.Unspecified).AddTicks(2355), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        {
                            Code = "5000",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 5, 6, 3, 55, 48, 695, DateTimeKind.Unspecified).AddTicks(2358), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("GreenDragonTrading.Domain.Entities.ModuleLayout", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 5, 6, 3, 55, 48, 695, DateTimeKind.Unspecified).AddTicks(2083), new TimeSpan(0, 0, 0, 0, 0)),
                            IsSystemDefault = true,
                            LayoutName = "Giao diện bộ lọc mặc định",
                            ModuleType = (short)1,
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 5, 6, 3, 55, 48, 695, DateTimeKind.Unspecified).AddTicks(2084), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
            ...
            modelBuilder.Entity("GreenDragonTrading.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            HashedPassword = "$2a$11$Rpv41LIHdtfxpPOoXImeie923EdNLavaYOSI4NzI1x9ZV7ZfX5dze",
