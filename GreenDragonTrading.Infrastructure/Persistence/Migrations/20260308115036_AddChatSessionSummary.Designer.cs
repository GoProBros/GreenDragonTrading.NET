...
namespace GreenDragonTrading.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260308115036_AddChatSessionSummary")]
            ...
            modelBuilder.Entity("GreenDragonTrading.Domain.Entities.AnalysisReportCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Code = "1000",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 3, 8, 11, 50, 35, 535, DateTimeKind.Unspecified).AddTicks(1962), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        {
                            Code = "2000",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 3, 8, 11, 50, 35, 535, DateTimeKind.Unspecified).AddTicks(1984), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        {
                            Code = "3000",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 3, 8, 11, 50, 35, 535, DateTimeKind.Unspecified).AddTicks(1987), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        {
                            Code = "4000",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 3, 8, 11, 50, 35, 535, DateTimeKind.Unspecified).AddTicks(1989), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        {
                            Code = "5000",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 3, 8, 11, 50, 35, 535, DateTimeKind.Unspecified).AddTicks(1992), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("GreenDragonTrading.Domain.Entities.ModuleLayout", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 3, 8, 11, 50, 35, 535, DateTimeKind.Unspecified).AddTicks(1851), new TimeSpan(0, 0, 0, 0, 0)),
                            IsSystemDefault = true,
                            LayoutName = "Giao diện bộ lọc mặc định",
                            ModuleType = (short)1,
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 3, 8, 11, 50, 35, 535, DateTimeKind.Unspecified).AddTicks(1852), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
            ...
            modelBuilder.Entity("GreenDragonTrading.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            HashedPassword = "$2a$11$sOvFKKXTAiaNMV/NtZ/YCev/R4s24n/4OtkzsbD.KNYhkOV8u4zU6",
            ...
            modelBuilder.Entity("GreenDragonTrading.Domain.Entities.Workspace", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 3, 8, 11, 50, 35, 535, DateTimeKind.Unspecified).AddTicks(1928), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDefault = true,
                            LayoutJson = "{\r\n          \"modules\": [\r\n            {\r\n              \"i\": \"stock-screener-default\",\r\n              \"type\": \"stock-screener\",\r\n              \"title\": \"Bộ lọc cổ phiếu\",\r\n              \"x\": 0, \"y\": 36, \"w\": 96, \"h\": 20,\r\n              \"activeLayoutId\": 1  \r\n            }\r\n          ]\r\n        }",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 3, 8, 11, 50, 35, 535, DateTimeKind.Unspecified).AddTicks(1929), new TimeSpan(0, 0, 0, 0, 0)),
