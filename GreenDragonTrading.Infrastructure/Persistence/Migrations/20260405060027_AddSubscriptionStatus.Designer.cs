...
namespace GreenDragonTrading.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260405060027_AddSubscriptionStatus")]
            ...
            modelBuilder.Entity("GreenDragonTrading.Domain.Entities.AnalysisReportCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Code = "1000",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 4, 5, 6, 0, 26, 834, DateTimeKind.Unspecified).AddTicks(7438), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        {
                            Code = "2000",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 4, 5, 6, 0, 26, 834, DateTimeKind.Unspecified).AddTicks(7457), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        {
                            Code = "3000",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 4, 5, 6, 0, 26, 834, DateTimeKind.Unspecified).AddTicks(7460), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        {
                            Code = "4000",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 4, 5, 6, 0, 26, 834, DateTimeKind.Unspecified).AddTicks(7462), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        {
                            Code = "5000",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 4, 5, 6, 0, 26, 834, DateTimeKind.Unspecified).AddTicks(7464), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("GreenDragonTrading.Domain.Entities.ModuleLayout", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 4, 5, 6, 0, 26, 834, DateTimeKind.Unspecified).AddTicks(7187), new TimeSpan(0, 0, 0, 0, 0)),
                            IsSystemDefault = true,
                            LayoutName = "Giao diện bộ lọc mặc định",
                            ModuleType = (short)1,
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 4, 5, 6, 0, 26, 834, DateTimeKind.Unspecified).AddTicks(7187), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
            ...
            modelBuilder.Entity("GreenDragonTrading.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            HashedPassword = "$2a$11$z1sujtj/iq9iX8luaJMEK.kw.ylLPJrkcseWs3H2cgOQ3l/ArJogG",
